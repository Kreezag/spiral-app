<template>
  <section
    v-if="event.contexts.device"
    class="py-5 px-4 md:px-6 lg:px-8 border-b"
  >
    ...
    <Table>
      <TableRow
        v-if="event.contexts.device.archs"
        :title="'Architectures'"
      >
        <CodeSnippet
          class="mt-3"
          language="json"
          :code="event.contexts.device.archs"
        />
      </TableRow>

      <TableRow
        v-if="event.contexts.device.battery_level"
        :title="'Battery Level'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.boot_time"
        :title="'Boot Time'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.brand"
        :title="'Brand'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.charging"
        :title="'Charging'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.family"
        :title="'Family'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.free_memory"
        :title="'Free Memory'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.free_storage"
        :title="'Free Storage'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.language"
        :title="'Language'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.low_memory"
        :title="'Low Memory'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.manufacturer"
        :title="'Manufacturer'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.memory_size"
        :title="'Memory Size'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.model"
        :title="'Model'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.model_id"
        :title="'Model Id'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.name"
        :title="'Name'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.orientation"
        :title="'Orientation'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.screen_density"
      ...
      <TableRow
        v-if="event.contexts.device.screen_dpi"
        :title="'Screen DPI'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.screen_height_pixels"
      ...
      <TableRow
        v-if="event.contexts.device.screen_width_pixels"
      ...
      <TableRow
        v-if="event.contexts.device.simulator"
        :title="'Simulator'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.storage_size"
        :title="'Storage Size'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.timezone"
        :title="'Timezone'"
      >
      ...
      <TableRow
        v-if="event.contexts.device.battery_temperature"
      ...
      <TableRow
        v-if="event.contexts.device.locale"
        :title="'Locale'"
      >
