<template>
  ...
  >
    ...
    <div
      style="height: 400px;"
      class="flex flex-col border border-purple-300 dark:border-purple-700 rounded"
    >
      <nav
          ...
          <div class="p-3">
            ...
            <div class="flex flex-row flex-wrap items-center text-purple-600 dark:text-purple-100 text-2xs my-3">
              <div class="flex border border-purple-300 dark:border-purple-700 rounded items-center mr-3 mb-2">
                <div class="px-2 border-r dark:border-purple-700">
                  type
                </div>
                <div class="px-2 bg-purple-100 dark:bg-purple-800 rounded-r font-bold">
                  {{ b.type }}
                </div>
              </div>
              <div class="flex border border-purple-300 dark:border-purple-700 rounded items-center mr-3 mb-2">
