<template>
  <section class="py-5 px-4 md:px-6 lg:px-8 border-b dark:border-gray-600">
    ...
    <div
      ...
      class="overflow-x-scroll border border-gray-50 dark:border-gray-600"
    >
      <div
      ...
      >
        ...
        >
          <div
            class="text-2xs md:text-xs font-bold text-muted whitespace-nowrap"
          ...
          <div
            class="h-2 md:h-3 lg:h-4 rounded min-w-1"
            :class="[row.color]"
            :style="{width: row.widthPercent + '%', 'margin-left': row.marginPercent + '%'}"
          />
        </div>
      </div>
    </div>
    <div
      v-else
      class="flex w-full flex-col items-center mt-5"
    >
      <div class="w-1/5">
